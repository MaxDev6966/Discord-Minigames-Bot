  ...
  run: async (client, message, args, user) => {
    ...
    if (!args[0]) {
      ...
      const embed = new MessageEmbed()
        ...
        .addField("• Developer", `\`\`\`yml\nName: 𝗠𝗔𝗫 𝗚𝗔𝗠𝗜𝗡𝗚 𝗬𝗧ᵈᵉᵛ🤖#8643 [806810037459746846]\n\`\`\``)
        .addField("• Important Links", `**[Invite Link](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot)\`|\`[Support Server](https://dsc.gg/development.world)\`|\`[Youtube](https://www.youtube.com/channel/UC1h8NFsqM4Gsd7VkFsQxSzA)\`**`)
